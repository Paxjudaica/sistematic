...
cd MegaETH-GTE
Install Python 3.x dari python.org
...
python main.py
Masukkan private key wallet (tanpa '0x')
Tentukan jumlah putaran swap yang diinginkan
Masukkan persentase saldo yang ingin digunakan untuk setiap swap
Keamanan
...
Dukungan
Untuk bantuan dan informasi lebih lanjut, silakan bergabung dengan grup Telegram kami: @winsnip
